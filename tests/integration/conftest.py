...
def pytest_runtest_setup(item):
    ...
    if item.get_closest_marker('needs_mitmproxy') and sys.version_info < (3, 9):
        pytest.skip('mitmproxy requires python 3.9 or greater')
    if item.get_closest_marker('needs_mitmproxy') and os.name == 'nt' and sys.version_info == (3, 9):
        pytest.skip('mitmproxy on windows requires python 3.10 or greater')
